...
public interface DataReader<T> {
	 ...
	 */
	List<T> Read(String source, String filename, Class<T> targetType ) throws ReadingModelFailedException, FileNotFoundException, IOException, InvalidParameterException  ;
}
